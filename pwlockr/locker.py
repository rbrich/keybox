    ...
    * password: Contains encrypted password, decrypted on access.
    ...
    def __str__(self):
        ...
        for column in self._record.get_columns():
            if column != 'password':
                width = self._locker.get_column_width(column)
    ...
    def __setitem__(self, key, value):
        ...
        if key == 'password':
            value = self._locker.encrypt_password(value)
    ...
    def touch(self):
        ...
        self._locker.update_width('mtime', mtime)
        self._locker.touch()
...
class Locker:
    ...
    def set_passphrase(self, new_passphrase):
        """Set new passphrase to locker and re-encrypt all record passwords."""
    ...
    def modified(self):
        """True if locker was modified since last read/write."""
        return self._modified

    def add_record(self, **kwargs) -> LockerRecord:
